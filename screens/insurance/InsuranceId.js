...
const CreditId = ({navigation}) => {
  ...
  console.log('insuranceDataSuccess: ', insuranceDataSuccess);
  console.log('errors: ', errors);

  const {createdAt, front, back} = insuranceData;
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.VerifyContent}>
          ...
          <TouchableOpacity
            onPress={() => {
              dispatch(updateInsurance(front, back));
